  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="mb-8">
          <h1 className="text-2xl font-bold sm:text-3xl">Post Lending Order</h1>
          <p className="mt-1 text-muted-foreground">Set your lending conditions, AI Agent will match the optimal borrower for you</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-border/50">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-base">Lending Amount</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="text-xs text-muted-foreground">Available Balance: 45,000 USDT · 32,000 USDC</div>
            </CardContent>
          </Card>
          ...
          <Card className="border-border/50">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-base">Annual Interest Rate</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <Card className="border-border/50">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-base">Repayment Method</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-border/50">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">{collateral ? "Collateral Required" : "No Collateral Required"}</span>
              </div>
              {collateral && (
          ...
          <Card className="border-border/50">
            ...
            >
              <span className="font-medium">Counterparty Requirements (Advanced)</span>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                <CardContent className="space-y-4 pt-0">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="mb-1 block text-xs text-muted-foreground">Minimum Credit Score</label>
                      <Input type="number" placeholder="e.g., 70" value={minCredit} onChange={(e) => setMinCredit(e.target.value)} />
                    </div>
                    <div>
                      <label className="mb-1 block text-xs text-muted-foreground">Minimum Transactions</label>
                      <Input type="number" placeholder="e.g., 3" value={minTxns} onChange={(e) => setMinTxns(e.target.value)} />
                    </div>
                  </div>
                  <div>
                    <label className="mb-1 block text-xs text-muted-foreground">Industry Preference</label>
                    <div className="flex flex-wrap gap-2">
                      {["Cross-border Trade", "Logistics", "Renewable Energy", "Agriculture", "Manufacturing", "Technology"].map((tag) => (
          ...
          <Card className="border-emerald-500/20 bg-gradient-to-br from-emerald-500/5 to-transparent">
            <CardContent className="p-5">
              ...
              <div className="mb-4 grid grid-cols-2 gap-2 text-sm">
                ...
                <span className="font-medium">{collateral ? `Yes (${collateralRate[0]}%)` : "No"}</span>
              </div>
              <Button
